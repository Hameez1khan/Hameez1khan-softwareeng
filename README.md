...
[OpenMetroMaps](https://www.openmetromaps.org/) project (with additional features implemented) used for educational purposes. The project was intentionally simplified by removing all web related subprojects.
