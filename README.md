...
[OpenMetroMaps](https://github.com/ftsrg-softeng/hw-2024-Hameez1khan-en) project (with additional features implemented) used for educational purposes. The project was intentionally simplified by removing all web related subprojects.
